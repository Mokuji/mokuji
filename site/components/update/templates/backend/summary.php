...
<h1><?php __('Update management'); ?></h1>
<input type="button" id="check_updates" class="button grey" value="<?php __('Check for updates'); ?>" />

<h2><?php __('Recent updates'); ?></h2>
<div id="recent-updates">
  
  <?php $data->latest_updates->each(function($version){ ?>
    ...
    <div class="version-wrapper">
      ...
      <?php $version->changes->each(function($change){ ?>
        ...
        <div class="change-wrapper">
          ...
          <?php echo $change->url->not('empty', function($url){
            return '<a href="'.$url.'" target="_blank">'.__('More information', 1).'</a>';
          }); ?>
        </div>
