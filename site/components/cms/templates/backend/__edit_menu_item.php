      ...
      <div class="title-bar page-title">
        ...
        <ul class="title-bar-icons clearfix">
          <?php if(tx('Component')->available('media')){ ?>
            <li><a href="#" class="icon menu-item-settings" id="toggle-menu-item-settings" title="<?php __($names->component, 'Toggle menu item settings'); ?>"><?php __($names->component, 'Toggle menu item settings', 'ucfirst') ?></a></li>
          <?php } ?>
