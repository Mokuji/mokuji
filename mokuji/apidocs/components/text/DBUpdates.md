...
## Property `$component`
In class: [components\text\DBUpdates](#top)
...
```
protected mixed $updates = array('1.1' => '1.2', '1.2' => '0.2.0-beta', '0.2.0-beta' => '0.2.1-beta')
```
...
```
mixed components\text\DBUpdates::install_1_2($dummydata, $forced)
```
