# components\text\models\ItemInfo
...
* Class name: ItemInfo
* Namespace: components\text\models
...
In class: [components\text\models\ItemInfo](#top)
...
```
protected mixed $relations = array('Items' => array('item_id' => 'Items.id'), 'Languages' => array('language_id' => 'Languages.id'))
```
...
```
protected mixed $table_name = 'text_item_info'
```
