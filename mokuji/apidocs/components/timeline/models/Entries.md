# components\timeline\models\Entries
...
```
protected mixed $relations = array('EntriesToTimelines' => array('id' => 'EntriesToTimelines.entry_id'), 'EntryInfo' => array('id' => 'EntryInfo.entry_id'))
```
...
```
protected mixed $table_name = 'timeline_entries'
```
...
```
mixed components\timeline\models\Entries::get_author()
```
...
```
mixed components\timeline\models\Entries::get_info()
```
...
```
mixed components\timeline\models\Entries::get_timelines()
```
