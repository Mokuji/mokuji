# components\timeline\models\EntriesToTimelines
...
In class: [components\timeline\models\EntriesToTimelines](#top)
...
```
protected mixed $relations = array('Entries' => array('entry_id' => 'Entries.id'), 'Timelines' => array('timeline_id' => 'Timelines.id'))
```
...
```
protected mixed $table_name = 'timeline_entries_to_timelines'
```
