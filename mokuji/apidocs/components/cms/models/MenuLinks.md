# components\cms\models\MenuLinks
...
**Methods**
* [`public mixed get_menu_item()`](#method-get_menu_item)
...
In class: [components\cms\models\MenuLinks](#top)
...
```
protected mixed $relations = array('MenuItem' => array('menu_item_id' => 'MenuItem.id'))
```
...
```
protected mixed $table_name = 'cms_menu_links'
```
...
```
mixed components\cms\models\MenuLinks::get_menu_item()
```
