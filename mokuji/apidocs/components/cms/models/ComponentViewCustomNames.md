# components\cms\models\ComponentViewCustomNames
...
* Class name: ComponentViewCustomNames
...
In class: [components\cms\models\ComponentViewCustomNames](#top)
...
```
protected mixed $relations = array('Languages' => array('lang_id' => 'Languages.id'), 'ComponentViews' => array('com_view_id' => 'ComponentViews.id'))
```
...
```
protected mixed $table_name = 'cms_component_view_custom_names'
```
