...
**Methods**
* [`protected mixed install()`](#method-install)
* [`protected mixed summary($options)`](#method-summary)
...
```
protected mixed $permissions = array('install' => 0)
```
...
```
mixed components\update\Views::install()
```
...
```
mixed components\update\Views::summary($options)
```
