...
**Methods**
* [`protected mixed settings_security()`](#method-settings_security)
...
## Property `$reserved`
In class: [components\security\Views](#top)
...
## Method `settings_security`
In class: [components\security\Views](#top)

```
mixed components\security\Views::settings_security()
```
