...
class DBUpdates extends \components\update\classes\BaseDBUpdates
{
  ...
  protected
    ...
    $updates = array(
      ...
      '3.0' => '0.7.0-beta', //No DB changes.
      '0.4.0' => '0.7.0-beta', //No DB changes.
      '0.4.1-beta' => '0.7.0-beta', //No DB changes.
      '0.5.0-beta' => '0.7.0-beta', //No DB changes.
      '0.6.0-beta' => '0.7.0-beta', //No DB changes.
      '0.7.0-beta' => '0.7.1-beta' //No DB changes.
    );
