...
class Json extends \dependencies\BaseViews
{
  ...
  protected function create_config_upgrade($data, $params)
  {
    ...
    fwrite($f,
      ...
      'define("DB_HOST","'.addslashes($data->host).'");'.n.
      'define("DB_USER","'.addslashes($data->username).'");'.n.
      'define("DB_PASS","'.addslashes($data->password).'");'.n.
      'define("DB_NAME","'.addslashes($data->name).'");'.n.
      'define("DB_PREFIX","'.addslashes($data->prefix).'");'
    );
