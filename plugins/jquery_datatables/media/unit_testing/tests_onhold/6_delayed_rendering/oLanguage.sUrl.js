...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			var bReturn = 
				...
				oSettings.oLanguage.sLengthMenu == "_MENU_ EintrÃƒÂ¤ge anzeigen" &&
				oSettings.oLanguage.sZeroRecords == "Keine EintrÃƒÂ¤ge vorhanden." &&
				oSettings.oLanguage.sInfo == "_START_ bis _END_ von _TOTAL_ EintrÃƒÂ¤gen" &&
				oSettings.oLanguage.sInfoEmpty == "0 bis 0 von 0 EintrÃƒÂ¤gen" &&
				oSettings.oLanguage.sInfoFiltered == "(gefiltert von _MAX_  EintrÃƒÂ¤gen)" &&
				oSettings.oLanguage.sInfoPostFix == "" &&
				oSettings.oLanguage.sSearch == "Suchen" &&
				oSettings.oLanguage.oPaginate.sFirst == "Erster" &&
				oSettings.oLanguage.oPaginate.sPrevious == "ZurÃƒÂ¼ck" &&
				oSettings.oLanguage.oPaginate.sNext == "NÃƒÂ¤chster" &&
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML = "1 bis 10 von 57 EintrÃƒÂ¤gen"; }
	);
