...
class Initializer
{
  ...
  public function is_installed()
  {
    ...
    $this->is_installed = @is_file($this->root.'.completed-install');
  ...
  private function load_config()
  {
    ...
    if($this->is_installed()){
      ...
      require_once($this->root.'config'.DS.'email.php');
      
      if($this->use_database){
        require_once($this->root.'config'.DS.'database.php');
      }
      
    }
    
    require_once($this->root.'config'.DS.'miscelanious.php');
  ...
  private function map_path_definitions($site)
  {
    ...
    define('PATH_COMPONENTS', PATH_BASE.DS.'components');
    define('PATH_TEMPLATES', PATH_BASE.DS.'templates');
    ...
    define('URL_COMPONENTS', URL_BASE.'components/');
    define('URL_TEMPLATES', URL_BASE.'templates/');
    define('URL_THEMES', URL_BASE.'themes/');
    define('URL_SYSTEM_ASSETS', URL_BASE.'system/assets/');
