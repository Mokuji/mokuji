...
```
protected mixed $relations = array('ItemInfo' => array('id' => 'ItemInfo.item_id'))
```
...
```
protected mixed $table_name = 'text_items'
```
...
```
mixed components\text\models\Items::get_info()
```
