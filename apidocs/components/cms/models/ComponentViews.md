# components\cms\models\ComponentViews
...
**Methods**
* [`public mixed get_component()`](#method-get_component)
* [`public mixed get_custom_names()`](#method-get_custom_names)
* [`public mixed get_preferred_description()`](#method-get_preferred_description)
* [`public mixed get_preferred_title()`](#method-get_preferred_title)
...
In class: [components\cms\models\ComponentViews](#top)
...
```
protected mixed $relations = array('Components' => array('com_id' => 'Components.id'), 'ComponentViewCustomNames' => array('id' => 'ComponentViewCustomNames.com_view_id'))
```
...
```
protected mixed $table_name = 'cms_component_views'
```
...
```
mixed components\cms\models\ComponentViews::get_component()
```
...
## Method `get_custom_names`
In class: [components\cms\models\ComponentViews](#top)

```
mixed components\cms\models\ComponentViews::get_custom_names()
```
...
## Method `get_preferred_description`
In class: [components\cms\models\ComponentViews](#top)

```
mixed components\cms\models\ComponentViews::get_preferred_description()
```
...
```
mixed components\cms\models\ComponentViews::get_preferred_title()
```
