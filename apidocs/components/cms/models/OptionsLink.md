# components\cms\models\OptionsLink
...
In class: [components\cms\models\OptionsLink](#top)
...
```
protected mixed $relations = array('Options' => array('option_id' => 'Options.id'), 'OptionSets' => array('optset_id' => 'OptionSets.id'))
```
...
```
protected mixed $table_name = 'cms_options_link'
```
