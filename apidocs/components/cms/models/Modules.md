...
In class: [components\cms\models\Modules](#top)
...
```
protected mixed $relations = array('Pages' => array('id' => 'ModulesPageLink.module_id'), 'ModulesPageLink' => array('id' => 'ModulesPageLink.module_id'), 'Components' => array('com_id' => 'Components.id'))
```
...
```
protected mixed $table_name = 'cms_component_modules'
```
