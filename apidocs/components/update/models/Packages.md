# components\update\models\Packages
...
**Methods**
* [`public mixed get_versions()`](#method-get_versions)
...
In class: [components\update\models\Packages](#top)
...
```
protected mixed $relations = array('PackageVersions' => array('id' => 'PackageVersions.package_id'))
```
...
```
protected mixed $table_name = 'update_packages'
```
...
```
mixed components\update\models\Packages::get_versions()
```
