# components\timeline\models\Pages
...
**Methods**
* [`public mixed get_display_type()`](#method-get_display_type)
* [`public mixed get_info()`](#method-get_info)
* [`public mixed get_timeline()`](#method-get_timeline)
...
```
protected mixed $table_name = 'timeline_pages'
```
...
```
mixed components\timeline\models\Pages::get_display_type()
```
...
```
mixed components\timeline\models\Pages::get_info()
```
...
```
mixed components\timeline\models\Pages::get_timeline()
```
