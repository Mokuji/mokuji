# components\timeline\models\DisplayTypes
...
In class: [components\timeline\models\DisplayTypes](#top)
...
```
protected mixed $table_name = 'timeline_display_types'
```
