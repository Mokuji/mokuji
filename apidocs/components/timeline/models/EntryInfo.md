# components\timeline\models\EntryInfo
...
```
protected mixed $table_name = 'timeline_entry_info'
```
...
```
protected mixed $validate = array('entry_id' => array('required', 'number' => 'int', 'gt' => 0), 'language_id' => array('required', 'number' => 'int', 'gt' => 0), 'title' => array('required', 'string', 'not_empty', 'no_html'), 'summary' => array('string'), 'content' => array('string'))
```
