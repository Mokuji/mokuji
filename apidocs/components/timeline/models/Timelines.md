# components\timeline\models\Timelines
...
```
protected mixed $relations = array('EntriesToTimelines' => array('id' => 'EntriesToTimelines.timeline_id'))
```
...
```
protected mixed $table_name = 'timeline_timelines'
```
...
```
protected mixed $validate = array('id' => array('required', 'number' => 'int', 'gt' => 0), 'title' => array('required', 'string', 'not_empty', 'no_html'), 'is_public' => array('boolean'))
```
