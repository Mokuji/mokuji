# components\account\models\AccountsToUserGroups
...
* Class name: AccountsToUserGroups
...
In class: [components\account\models\AccountsToUserGroups](#top)
...
```
protected mixed $relations = array('Accounts' => array('user_id' => 'Accounts.id'), 'UserGroups' => array('user_group_id' => 'UserGroups.id'))
```
...
```
protected mixed $table_name = 'account_accounts_to_user_groups'
```
