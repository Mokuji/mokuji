# components\account\models\UserInfo
...
## Class index
**Constants**
* [`STATUS_ACTIVATED`](#constant-status_activated)
* [`STATUS_BANNED`](#constant-status_banned)
* [`STATUS_CLAIMABLE`](#constant-status_claimable)
...
```
protected mixed $relations = array('Accounts' => array('user_id' => 'Accounts.id'))
```
...
```
protected mixed $table_name = 'account_user_info'
```
...
```
\components\account\models\UserInfo components\account\models\UserInfo::check_status(mixed $value, $callback)
```
...
* $value **mixed** - The status to check for either EXACT int (discoraged) or string.
* $callback **mixed**


#### Return value

**[components\account\models\UserInfo](../../../components/account/models/UserInfo.md)** - $this is returned for chaining.
...
```
mixed components\account\models\UserInfo::get_full_name()
```
...
```
mixed components\account\models\UserInfo::set_status($value)
```
...
```
mixed components\account\models\UserInfo::get_account()
```
