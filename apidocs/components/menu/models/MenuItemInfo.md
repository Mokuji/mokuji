# components\menu\models\MenuItemInfo
...
In class: [components\menu\models\MenuItemInfo](#top)
...
```
protected mixed $relations = array('MenuItems' => array('item_id' => 'MenuItems.id'))
```
...
```
protected mixed $table_name = 'menu_item_info'
```
