...
**Methods**
* `public mixed __construct($url, array $options)`
* `public mixed __toString()`
* `public mixed compare(\dependencies\Url $url)`
* `public mixed rebuild_output()`
* `private mixed _build_url($string, array $options)`
...
* $url **[dependencies\Url](dependencies-Url)**
