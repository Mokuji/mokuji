# dependencies\forms\CheckBoxField
...
```
mixed dependencies\forms\CheckBoxField::__construct(string $column_name, string $title, \dependencies\BaseModel $model, array $options)
```
...
```
mixed dependencies\forms\CheckBoxField::render(array $options)
```
