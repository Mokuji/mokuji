...
**Methods**
* `public \components\account\models\UserInfo check_status(mixed $value, $callback)`
* `public mixed get_full_name()`
* `public mixed set_status($value)`
* `protected mixed get_account()`
